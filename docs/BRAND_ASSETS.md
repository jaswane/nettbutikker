...
| Power | `public/logos/power.svg` | Butikkens eget CDN (headerlogo): `media.power-cdn.net/images/logos/powerno/logo.svg` | 2026-07-16 | Ren vektor, 223.8×50, hvit tekst + oransje (#f96700) → krever mørk flate: `background: "dark"`. Sikkerhetssjekket: ingen script/eksterne refs. |
| Multicom | `public/logos/multicom.svg` | Butikkens eget CDN (headerlogo): `img2-327a.kxcdn.com/di1.ashx/89/2192465` (SVG) | 2026-07-16 | Ren vektor, 164×41, grå (#6B6E71) på transparent → `background: "transparent"`. Sikkerhetssjekket. |
| Sport 1 | `public/logos/sport-1.svg` | Butikkens egen nettside (inline header-SVG, «Gå til hjemmesiden») | 2026-07-16 | Ren vektor, 103×32, mørkeblå (#063D65) + rød (#D0043C) → `background: "light"`. Sikkerhetssjekket. |
| Milrab | `public/logos/milrab.svg` | Butikkens eget CDN (headerlogo): `cdn.sanity.io/images/uze90wod/widforss-production/6bc64a…-548x168.svg` | 2026-07-16 | Ren vektor, 548×168, svart på transparent → `background: "light"`. Sikkerhetssjekket. |
| Barnas Hus | `public/logos/barnas-hus.svg` | Butikkens egen nettside (inline header-SVG ved forsidelenken) | 2026-07-16 | Ren vektor, 106×56, selvbærende rød flate (#E31D14) med hvit figur → `background: "transparent"`. Sikkerhetssjekket. |
